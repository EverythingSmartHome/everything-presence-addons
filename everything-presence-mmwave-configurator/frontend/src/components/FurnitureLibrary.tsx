...
export const FurnitureLibrary: React.FC<FurnitureLibraryProps> = ({ onSelect, onClose }) => {
  ...
  return (
    <div className="fixed inset-y-0 right-0 z-50 w-96 bg-slate-900/95 backdrop-blur border-l border-slate-700 shadow-2xl flex flex-col">
      {/* Header */}
        ...
        <div className="grid grid-cols-2 gap-4">
          {furniture.map((item) => {
            ...
            return (
              ...
              >
                {/* Icon */}
                <div className="w-20 h-20 flex items-center justify-center text-slate-300 group-hover:text-aqua-400 transition-colors">
                  {Icon ? (
